#!/bin/bash
python3 fq_trim.py 1
python3 fq_pos_on_graph.py 1
python3 fq_trim.py 22
python3 fq_pos_on_graph.py 22
python3 gfa_trim.py 1
python3 gfa_trim.py 22
...
for gene in 1 22; do
    ...
    if [ -f "$sampled_indices_file" ]; then
        ...
        while IFS= read -r index; do
            ...
            python3 ./gfa_encode.py $index $gene
